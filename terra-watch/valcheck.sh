...
[ -z $MONIKER ] && echo "[ERROR] Must provide moniker name (-m)" && exit 1
...
[ -z $CONSENSUS_PUBKEY ] && echo "[ERROR] CONSENSUS_PUBKEY not found" && exit 1
[ -z $VALIDATORBECH ] && echo "[ERROR] VALIDATORBECH not found" && exit 1
